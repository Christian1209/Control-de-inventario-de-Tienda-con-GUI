...
namespace CRUD
{
    public partial class FormAltas : Form
    {
        ...
        {
            List<alta> lista = new List<alta>();
            ctrlaltas _ctrlventas = new ctrlaltas();
        ...
        {
            dtagridVenta.Columns["id"].Visible = false;
        ...
        private void cbConsulta2_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void btnConsulta_Click(object sender, EventArgs e)
        {
            ...
            {
                dtagridVenta.Columns["id"].Visible = true;
                col1 = true;
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            string sql = "DELETE FROM altas WHERE id = '" + id + "'";
